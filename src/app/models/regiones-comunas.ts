export const REGIONES_COMUNAS = [
    ...
    },
    {
      ...
      comunas: ['La Serena', 'Coquimbo', 'Andacollo', 'La Higuera', 'Vicuña', 'Paihuano', 'Illapel', 'Canela', 'Los Vilos', 'Salamanca', 'Ovalle', 'Monte Patria', 'Combarbalá', 'Punitaqui', 'Río Hurtado']
    },
    {
      region: 'Región de Valparaíso',
      comunas: ['Valparaíso', 'Viña del Mar', 'Concón', 'Quintero', 'Puchuncaví', 'Casablanca', 'Quilpué', 'Villa Alemana', 'Limache', 'Olmué', 'Quillota', 'La Calera', 'Nogales', 'Hijuelas', 'La Cruz', 'San Antonio', 'Cartagena', 'El Quisco', 'El Tabo', 'Algarrobo', 'Santo Domingo', 'San Felipe', 'Llaillay', 'Catemu', 'Putaendo', 'Panquehue', 'Santa María', 'Los Andes', 'Calle Larga', 'Rinconada', 'San Esteban', 'Isla de Pascua', 'Juan Fernández', 'Petorca', 'La Ligua', 'Cabildo', 'Zapallar', 'Papudo']
    },
    {
